...
- (void)viewDidLoad {
    ...
    c1.tabBarItem.imageInsets = UIEdgeInsetsMake(6, 0, -6, 0);
    ...
    c2.tabBarItem.imageInsets = UIEdgeInsetsMake(6, 0, -6, 0);
...
//    c3.tabBarItem.selectedImage = [[UIImage imageNamed:@""] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    ...
    c4.tabBarItem.imageInsets = UIEdgeInsetsMake(6, 0, -6, 0);
    ...
    c5.tabBarItem.imageInsets = UIEdgeInsetsMake(6, 0, -6, 0);
