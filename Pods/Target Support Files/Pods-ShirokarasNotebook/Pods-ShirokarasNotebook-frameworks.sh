...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/MBProgressHUD+BWMExtension/MBProgressHUD_BWMExtension.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/UIImage+animatedGif/UIImage_animatedGif.framework"
